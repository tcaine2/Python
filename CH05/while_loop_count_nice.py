...
# NAME: Thomas Caine
# DATE: 10/21/24
# BRIEF DESCRIPTION: This lab will function the same as the while_loop_count lab but 
# instead of outputting each number on a separate line we will output them all on one 
